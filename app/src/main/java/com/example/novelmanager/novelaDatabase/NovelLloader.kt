...
class NovelLoader(context: Context) : AsyncTaskLoader<List<Novel>>(context) {
    ...
    private fun loadNovelsFromDatabase(): List<Novel>? {
        ...
        return listOf(
            Novel(id = 1, title = "Sample Title 1", author = "Author 1", year = 2021, synopsis = "Synopsis 1", isFavorite = true, latitude = 0.0, longitude = 0.0),
            Novel(id = 2, title = "Sample Title 2", author = "Author 2", year = 2022, synopsis = "Synopsis 2", isFavorite = false, latitude = 0.0, longitude = 0.0),
        )
    }
}